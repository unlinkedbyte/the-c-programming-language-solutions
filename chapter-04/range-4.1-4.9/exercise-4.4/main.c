// Exercise 4.4: Add commands to print the top element on the stack without poping, to duplicate it, and to swap the two elements. Add a command to clear the stack.
